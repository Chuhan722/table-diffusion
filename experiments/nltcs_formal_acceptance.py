#!/usr/bin/env python3
"""
NLTCS 正式实验：A0 vs A1 接受规则对照
配对对照设计，固定 ρ=0.01，使用残差降速驱动的 α 调度（probe 模式）
"""
...
def main():
    """主函数：运行所有实验"""
    print("="*60)
    print("NLTCS 正式实验: A0 vs A1 接受规则")
    print(f"种子: {SEEDS}")
    print(f"轮数: {N_ROUNDS}")
    print(f"固定参数: ρ={RHO}, W={W}")
    print("="*60)

    output_base = Path("results") / "nltcs_formal_acceptance"
