...
from scripts import recover_issue53_gap_weight_sqrt_screen as recovery
...
def test_actual_frozen_two_cases_validate_without_quality_interpretation():
    root = _artifact_root()
...
def test_recovery_source_has_no_generation_or_quality_evaluation_entrypoints():
    source = (
        ROOT / "scripts/recover_issue53_gap_weight_sqrt_screen.py"
