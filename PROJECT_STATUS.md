...
语义保留。正式 JSON SHA-256
`e3972f8d6f02d7dbd55e8cd5e5ae172a8b2ed20730f46016368eb0bcf53f28ed`。

**扩散必要性对 rho 稳健**（PR #47 同步重跑，rho=0.01）：无门条件扩散/随机
= 0.104（5/5 全胜），有门条件随机/扩散 = 18.97——方向必要、门救不了随机核，
两标志在 rho∈{0.1, 0.01} 下一致成立。消融 JSON SHA-256
`41ca366440b9117e8dd2aa529336a7725181283b538147086de293f120052f30`。
